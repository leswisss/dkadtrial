...
export const accordionAnim = {
  initial: {
    opacity: {value: 0, transition: {duration: 0.5, ease: [0.7, 0, 0.3, 1]}},
    top: {value: "100%", transition: {duration: 1, ease: [0.7, 0, 0.3, 1], delay: 0.5}}
  },
  enter: {
    opacity: {value: 1, transition: {duration: 0.5, ease: [0.7, 0, 0.3, 1]}},
