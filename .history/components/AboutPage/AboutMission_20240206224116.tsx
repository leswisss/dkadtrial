...
const AboutMission = () => {
  ...
  const changeSlide = () => {
    setActiveSlide((prevSlide) => {
      return (prevSlide + 1) % images.length; // This will loop back to the first slide after the last one
    });
  };
          ...
          <div className={styles.values__wrapper}>
            <div className={styles.values__content}>
              ...
              <div className={styles.v__content}>
                <div className={styles.v__header}>{splitwords(ValuesData[activeSlide].name, active)}</div>
              ...
              <div className={styles.buttons}>
                {ValuesData.map((data, i) => (
                  <div className={styles.progress__wrapper} key={i} onClick={() => handleButtonClick(i)}>
