  ...
  return (
    <section className={`${styles.mission__section}`}>
      ...
      <div className={`container ${styles.mission__container}`}>
        <div className={styles.mission} ref={ref} style={{clipPath: inView ? "polygon(0 0, 100% 0, 100% 100%, 0 100%)" : "polygon(0 0, 100% 0, 100% 0, 0 0)", transition: "clip-path 0.7s cubic-"}}>
