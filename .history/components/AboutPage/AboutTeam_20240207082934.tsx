...
const AboutTeam = () => {
  ...
  const text2 = "Voici DKAD : un groupe dynamique d'architectes, chacun expert dans son domaine, unis par une vision commune. Dédiés à la transformation des espaces, à la création de designs innovants et à la réalisation de rêves architecturaux - nous façonnons ensemble l'avenir de l'architecture."
