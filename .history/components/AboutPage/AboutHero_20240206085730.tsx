...
const AboutHero = () => {
  const text1 = "Chez DKAD, notre premier point de compréhension tourne autour de notre esprit d'innovation. Qu'il s'agisse de design, de conscience écologique ou d'une multitude d'activités, nous prenons toujours en compte la stratégie globale."
  const text2 = "Il s'agit de réfléchir sérieusement à l'impact durable d'un projet, non seulement pour nous, mais aussi pour les parties concernées, les utilisateurs finaux et, bien sûr, l'environnement."
