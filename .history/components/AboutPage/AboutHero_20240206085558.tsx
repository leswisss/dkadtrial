...
const AboutHero = () => {
  const text1 = "Chez DKAD, notre premier point de compréhension tourne autour de notre esprit d'innovation. Qu'il s'agisse de design, de conscience écologique ou d'une multitude d'activités, nous
