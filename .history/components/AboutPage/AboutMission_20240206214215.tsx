...
const AboutMission = () => {
  ...
  //Word splitting
  const [active, setActiveS] = useState(true);
        ...
        <div className={styles.values}>
          <div className={styles.values__wrapper}>
            <div className={styles.values__content}>
              <span className={styles.h__text}>{splitwords(text1, active)}</span>
              <div className={styles.v__content}>
                <div className={styles.v__header}>{splitwords(text3, active)}</div>
