...
const AboutMission = () => {
  ...
  const text2= "Dans le domaine dynamique de l'architecture, l'adaptabilité est essentielle. Chez DKAD, nous acceptons le changement et considérons chaque défi comme une occasion d'apprendre et de progresser. Notre approche flexible nous permet d'offrir des
  solutions novatrices qui répondent aux besoins uniques de
  nos clients."
        ...
        <div className={styles.values}>
          <div className={styles.values__wrapper}>
            <div className={styles.values__content}>
              <span className={styles.h__text}>Nos Valeurs</span>
              <div className={styles.v__content}>
                <div className={styles.v__header}>Adaptabilite</div>
                <div className={styles.p__text}>
                  <p>
                    Dans le domaine dynamique de l'architecture, l'adaptabilité
                    est essentielle. Chez DKAD, nous acceptons le changement et
                    considérons chaque défi comme une occasion d'apprendre et de
                    progresser. Notre approche flexible nous permet d'offrir des
                    solutions novatrices qui répondent aux besoins uniques de
                    nos clients.
                  </p>
                </div>
              ...
              <div className={styles.buttons}>
                {[0, 1, 2, 3, 4].map((text, i) => (
                  <div className={styles.progress__wrapper} key={i}>
