...
const AboutMission = () => {
  ...
  useEffect(() => {
    if (progressWrapperRefs.current.length > 1) {
      ...
      if (firstOffset !== undefined && secondOffset !== undefined && firstWidth !== undefined) {
          ...
          <div className={styles.values__wrapper}>
            <div className={styles.values__content}>
              ...
              <div className={styles.buttons}>
                ...
                <div className={styles.progress} style={{transform: `translateX(calc(${activeSlide}*100% + ${activeSlide*gapper/16}rem))`}}></div>
              </div>
            </div>
