...
const AboutMission = () => {
  ...
  const text2= "Dans le domaine dynamique de l'architecture, l'adaptabilité est essentielle. Chez DKAD, nous acceptons le changement et considérons chaque défi comme une occasion d'apprendre et de
