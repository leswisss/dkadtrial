...
const AboutHero = () => {
  ...
  const text2 = "Il s'agit de réfléchir sérieusement à l'impact durable d'un projet, non seulement pour nous, mais aussi pour les parties concernées, les utilisateurs finaux et, bien sûr,
  l'environnement."
