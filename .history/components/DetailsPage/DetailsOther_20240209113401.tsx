          ...
          {MoreProjects.map((data, i) => {
            ...
            return (
              <SwiperSlide className={styles.other__slide} key={i}>
                <Link className={styles.other__content} href="/" onMouseEnter={() => setActive(true)} onMouseLeave={() => setActive(false)}>
                  <div className={styles.other__image} ref={container}>
                    <motion.div className={styles.other__overflow} animate={{scale: active ? 1.05 : 1}} transition={{duration: 0.5, ease: [0.7, 0, 0.3, 1]}}>
                      <motion.div
