      ...
      <div className={`container ${styles.details__container}`}>
        .<div className={styles.d__top}>
          ...
          <div className={styles.about__content}>
            ...
            <p>Le garage ouvert au rez-de-chaussée offre une commodité sans compromis sur le design. L'utilisation de matériaux durables et l'intégration transparente dans l'environnement soulignent notre engagement en faveur d'un mode de vie respectueux de l'environnement. </p>
          </div>
        </div>
        <div className={styles.d__top}>
        <div className={styles.about__title}>
