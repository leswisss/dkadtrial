        ...
        <div className={styles.more__wrapper}>
          ...
          <div className={styles.more__overlay}>
            <div className={styles.overlay__content}>
              <p>Poser les bases : La première étape de la réalisation du rêve du Sunset Sanctuary Retreat. Poser les bases : La première étape de la réalisation du rêve du Sunset Sanctuary Retreat.</p>
            </div>
          </div>
        </div>
