    ...
    return (
      <div className={styles.swiper__buttons}>
        <span
          ...
          style={{ cursor: swiper.activeIndex === 0 ? "default" : "pointer" }}
        >
        ...
        <span
          ...
          style={{ cursor: lastSlide ? "default" : "pointer" }}
        >
      ...
      <div className={`container ${styles.other__container}`}>
        ...
        <Swiper
          ...
          onSlideChange={(swiper) => {
            ...
            if (swiper.isEnd) {
              console.log('Last slide is in the viewport.');
              // Perform any actions specific to the last slide.
            }
          }}
        >
          <SwiperButtons />
