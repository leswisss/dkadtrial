  ...
  return (
    <section className={`section ${styles.other__section}`}>
      <div className={`container ${styles.other__container}`}>
        ...
        <Swiper className={styles.other__swiper} {...swiperSettings} speed={600}>
          <SwiperButtons />
          {MoreProjects.map((data, i) => {
            ...
            return (
              <SwiperSlide className={styles.other__slide} key={i} ref={}>
                <Link className={styles.other__content} href="/" ref={container}>
