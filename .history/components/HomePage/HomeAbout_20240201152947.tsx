    ...
    <section ref={reference} className={styles.about__section}>
      <div className={`container ${styles.about__container}`}>
          ...
          <div className={styles.about__content}>
            ...
            <div className={styles.content__three}>
              <div className={styles.main__image_wrapper}>
                <div className={styles.main__image_swiper}>
                  <Image src={IMAGE} alt="Interior Design" fill quality={100}/>
                </div>
              </div>
              <div className={styles.secondary__image_wrapper}>
                <div className={styles.secondary__image_swiper}>
                  <Image src={IMAGE2} alt="Interior Design" fill quality={100}/>
                </div>
              </div>
              <div className={styles.secondary__image_wrapper}>
                <div className={`${styles.secondary__image_swiper} ${styles.transform}`}>
                  <Image src={IMAGE3} alt="Interior Design" fill quality={100}/>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={styles.about__main}>
          ...
          <div className={styles.about__content}>
            <div className={styles.content__one}>
              <p>Fondée par Donfack Kengni en 2024, DKAD est une entreprise d'architecture de premier plan avec une concentration stratégique sur la création d'espaces inspirants à long terme.</p>
            </div>
            <div className={styles.content__two}>
              <div className={styles.content__two_main}>
                <p>Notre vaste champ d'action et nos intérêts variés nous permettent de trouver des opportunités dans des projets architecturaux conventionnels et innovants, avec un accent particulier sur la conception durable.</p>
              </div>
              <div className={styles.content__two_main}>
                <p>Nous accordons de l'importance à un savoir-faire exceptionnel, à des expériences uniques et à des opportunités durables et personnalisées.</p>
              </div>
            </div>
          </div>
        </div>
