...
const ProjectsBottom = () => {
  ...
  const animateSlide = (slideNumber: number, reveal: boolean) => {
    ...
    gsap.to(background, { clipPath: clipPathValue, duration: 0.7, ease: 'cubic-bezier(0.7, 0, 0.3, 1)' });
    gsap.to(img, { clipPath: clipPathValue, duration: 0.7, ease: 'cubic-bezier(.17,.67,.83,.67)' });
  };
