              ...
              <div className={styles.details__bottom}>
                ...
                <div className={styles.bottom__right}>
                  ...
                  <div className={styles.bottom__bottom}>
                    <Rounded backgroundColor="#ffffff" classNames={styles.rounded__button} link="/">
          ...
          <div className={styles.cursor}>
            <div className={styles.cursor__content}>
              <div className={styles.cursor__swiper}>
                <div className={styles.}><Icon icon="la:angle-left" /> <span>1/3</span> <Icon icon="la:angle-right" /></div>
                <span>View</span>
              </div>
            </div>
          </div>
