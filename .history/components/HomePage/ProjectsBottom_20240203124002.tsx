        ...
        <div className={styles.projects__content} ref={container}>
          <motion.div style={{ y }} className={styles.background__images}>
            {ProjectsContent.map((content, i) => (
              <div className={`${styles.background__image} ${activeProject===0 ? styles.active__background : ""}`} key={i}>
                <Image
                  src={content.image}
                  fill
                  alt="Project Image"
          ...
          <div className={styles.project__images}>
            {ProjectsContent.map((content, i) => (
              <div className={`${styles.project__image} ${activeProject===0 ? styles.active__image : ""}`} key={i}>
                <Image
                  src={content.image2}
                  fill
                  alt="Project Image"
