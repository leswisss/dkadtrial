            ...
            <div className={styles.content__three}>
              <div className={styles.main__image_wrapper} ref={ref3}>
                <div
                  ...
                  style={{ transform: `translateX(${-activeImage * 33.33}%)`, height: inView3 ? "100%" : "0%" }}
                >
              ...
              {IMAGES.map((image, i) => (
                ...
                >
                  <div className={styles.secondary__image_swiper} style={{ transform: `translateX(${-activeImage * 33.33}%)`, height: inView3 ? "100%" : "0%" }}>
                    <Image
                      src={image}
                      alt="Interior Design"
                      fill
