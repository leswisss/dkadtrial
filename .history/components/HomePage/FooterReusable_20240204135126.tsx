        ...
        <div className={styles.left}>
          <div className={styles.left__content}>
            <div className={styles.left__top}>
              <div className={styles.header__one}>{data.title}</div>
              <div className={styles.header__two}>{data.title2}</div>
            </div>
            <div className={styles.left__bottom}>
              <p className="p__text">{data.text}</p>
              <div>
                <Link href={`/${currentlocale}${data.link}`}>
                  <Icon icon="fluent:arrow-up-28-regular" />
                </Link>
              </div>
            </div>
          </div>
