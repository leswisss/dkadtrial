      ...
      <div className={`container ${styles.contact__container}`}>
        <div className={styles.contact__top}>
          <div className={styles.top__one}>
            <p className={styles.p}>Nous vous aiderons a mettre en oeuvre</p>
          </div>
          <div className={styles.line}></div>
          <div className={styles.top__two}>
            <p className={styles.p}>toutes solutions de <span className={styles.text__fade}>conception</span></p>
          </div>
        </div>
