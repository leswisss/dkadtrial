...
const HomeHero = ({lenis, reference}: {lenis: Lenis | null, reference: React.RefObject<HTMLDivElement> }) => {
  ...
  const handleLenisScroll = () => {
    if (lenis && homeInfoRef.current) {
      const homeInfoTop = homeInfoRef.current.getBoundingClientRect().top;
      lenis.scrollTo(homeInfoTop);
    }
