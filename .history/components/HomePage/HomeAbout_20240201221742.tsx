            ...
            <div className={styles.content__three}>
              <div className={styles.main__image_wrapper} ref={ref3}>
                <div
                  ...
                  style={{ transform: `translateX(${-activeImage * 33.33}%)`, clipPath: inView3 ? "clip-path: polygon(0 0, 100% 0, 100% 100%, 0 100%);" }}
                >
              ...
              {IMAGES.map((image, i) => (
                ...
                >
                  <div className={styles.secondary__image_swiper} style={{  }}>
                    <Image
                      src={image}
                      alt="Interior Design"
                      fill
