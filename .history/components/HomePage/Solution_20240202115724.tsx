...
const Solution = ({
  ...
  return (
    <>
      ...
      >
        <motion.div variants={modalAnimation} initial="initial" animate={activeModal ? "entry" : "initial"} className={styles.sm__content}>
