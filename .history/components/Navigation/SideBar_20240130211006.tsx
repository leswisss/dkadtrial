...
const SideBar = ({activeSide, setActiveSide}: sideBarProps) => {
  ...
  const sidebarRef = useRef<HTMLDiv(null)
    ...
    <div className={styles.sidebar}>
      <div className={`container ${styles.sidebar__container}`}>
        <div className={styles.sidebar__top}>
          <span className={styles.close__text} onClick={() => setActiveSide(false)}>Close</span>
          <LanguageSelector />
        </div>
        <div className={styles.sidebar__content}>
          <div className={styles.sc__left}>
            ...
            <div className={styles.text__container}>
              <div className={styles.text__slider} style={{transform: `translateY(${-activeLink * 100}%)`}}>
                {SideMenu.map((data, i) => (
