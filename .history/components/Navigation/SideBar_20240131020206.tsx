...
import { sideBarAnim, sideBarImageAnim } from "@/animations";
...
const SideBar = ({ activeSide, setActiveSide }: sideBarProps) => {
  ...
  return (
    <motion.div variants={sideBarAnim} animate={activeSide ? "entry" : "initial"} exit="exit" className={styles.sidebar}>
        ...
        <div className={`container ${styles.sidebar__container}`}>
          ...
          <div className={styles.sidebar__content}>
            <div className={styles.sc__left}>
              <motion.div variants={sideBarImageAnim} animate={activeSide ? "entry" : "initial"} exit="exit" className={styles.images}>
