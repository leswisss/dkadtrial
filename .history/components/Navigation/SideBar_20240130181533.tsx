      ...
      <div className={`container ${styles.sidebar__container}`}>
        ...
        <div className={styles.sidebar__content}>
          <div className={styles.sc__left}>
            <div className={styles.images}>
              <div className={styles.image__wrapper}>
                {
                  SideMenu.map((data, i) => (
                    <Image key={i} src={data.image} width={400} height={350} alt={data.name} quality={100} loading="eager"/>
                  ))
                }
              </div>
            </div>
            <div className={styles.text__container}>
              <div className={styles.text__slider}>
                {
                  SideMenu.map((data, i) => (
                    <div key={i} className={styles.slider__text}>{data.name}</div>
                  ))
                }
              </div>
            </div>
          ...
          <div className={styles.sc__right}>
            ...
            <Rounded backgroundColor="#013cac" classNames={styles.cta_button} link={`/${lang}/contact`}>
                <p>{t("contact")}</p>
              </Rounded>
