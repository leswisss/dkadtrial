...
export default function Rounded({children, backgroundColor="#455CE9", link, className, ...attributes}: {children: React.ReactNode, backgroundColor: string, link:string, className?: string}) {
