...
export default function Rounded({children, backgroundColor="#455CE9", link, classNames, ...attributes}: {children: React.ReactNode, backgroundColor: string, link:string, classNames=}) {
