...
export default function Rounded({children, backgroundColor="#455CE9", link, ...attributes}: {children: React.ReactNode, backgroundColor: string, link:string, className?: string}) {
