  ...
  return (
    <section className={styles.footer__wrapper}>
      ...
      <div className={styles.footer__image_wrapper}>
        <motion.div className={styles.footer__image_content}>
          <div className={`container ${styles.footeri__container}`}>
            <h3>DONFACK KENGNI<br/>ARCHITECTURE & DESIGN</h3>
            <div className={styles.footer__footer}>
              <span>&copy; DKAD {year}</span>
              <span>Built by <span className={styles.underline}>Better Marque</span></span>
            </div>
          </div>
