...
const Footer = () => {
  ...
  const home_trans = "Contact"
  const pro_trans = t("projets") 
  const about_trans = t("apropos")
  const serv_trans = "Services"

  const navigation__menu = [about_trans, serv_trans, home_trans, pro_trans]
  ...
  return (
    <section className={styles.footer__wrapper}>
      ...
      <div className={styles.footer__image_wrapper}>
        <motion.div className={styles.footer__image_content} ref={container} style={{y}}>
          <div className={`container ${styles.footeri__container}`}>
            ...
            <div className={styles.footer__footer}>
              ...
              <span>
                Built in Cameroon by <span className={styles.underline}>Better Marque</span>
              </span>
            </div>
          </div>
          <div className={styles.footer__image}>
            <Image loading="eager" src={IMAGE} alt="Carte de Visiste" fill quality={100} />
          </div>
        </motion.div>
      </div>
    </section>
