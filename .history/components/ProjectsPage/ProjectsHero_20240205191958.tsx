...
const ProjectsHero = () => {
  ...
  const filters = [
    ...
    {
      name: "Extérieur",
      link:  currentLocale==="en" ? `/${currentLocale}/projects?service=extérieur`: `/${currentLocale}/projects?service=extérieur` 
    },
    {
      name: "Aménagement Paysager",
      link:  currentLocale==="en" ? `/${currentLocale}/projects?service=aménagement paysager`
    }
  ]
