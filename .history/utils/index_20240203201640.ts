...
export const Landscape = {
    ...
    text2: "nous concevons des paysages qui respectent l’environnement et répondent aux besoins spécifiques de nos clients. Nos plans innovants favorisent la biodiversité, encouragent la durabilité et améliorent la qualité de vie.",
    image: IMAGE7,
}
