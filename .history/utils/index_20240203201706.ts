...
export const Landscape = {
    ...
    text2: "nous concevons des paysages qui respectent l'environnement et répondent aux besoins spécifiques de nos clients. Nos plans innovants favorisent la biodiversité, encouragent la durabilité et améliorent la qualité de vie. Nous créons des designs qui permettent à d'autres de réaliser des paysages magnifiques et durables.",
    image: IMAGE7,
}
